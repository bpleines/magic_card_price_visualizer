...
class ScryfallScraper:
    ...
    def extract_card_data(self, card_data_json):
        if card_data_json is None:
            return None
        cards = []
    ...
    def generate_local_csv(self, set_or_color_code : str):
        ...
        if cards is not None:
            ...
            logging.info(f"Generated csv data for: {set_or_color_code}")
    ...
    def query_card_color_data(self, color_code : str):
        ...
        while response.get('has_more'):
            ...
            card_data.append(paginated_response.get("data"))
        if not card_data:
